...
def generate_positive_viewpoint_description(base_text):    
    ...
    5. **Perspective Consistency**: If viewpoint is Top-Down, do NOT mention height, 'rising,' or 'tall.' If viewpoint is Ground-Up, do NOT mention 'footprints' or 'roof-tops.' Ensure the physics matches a single camera lens."
