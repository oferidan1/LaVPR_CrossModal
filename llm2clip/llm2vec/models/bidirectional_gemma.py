...
try:
    from transformers.models.gemma.modeling_gemma import GEMMA_ATTENTION_CLASSES as HF_GEMMA_ATTENTION_CLASSES
except ImportError:
    HF_GEMMA_ATTENTION_CLASSES = {"eager": GemmaAttention}
    try:
        from transformers.models.gemma.modeling_gemma import GemmaFlashAttention2
        HF_GEMMA_ATTENTION_CLASSES["flash_attention_2"] = GemmaFlashAttention2
    except ImportError:
        pass
    try:
        from transformers.models.gemma.modeling_gemma import GemmaSdpaAttention
        HF_GEMMA_ATTENTION_CLASSES["sdpa"] = GemmaSdpaAttention
    except ImportError:
        pass

GEMMA_ATTENTION_CLASSES = {}
for key, cls in HF_GEMMA_ATTENTION_CLASSES.items():
    class ModifiedAttention(cls):
        def __init__(self, *args, **kwargs):
            super().__init__(*args, **kwargs)
            self.is_causal = False
    ModifiedAttention.__name__ = f"Modified{cls.__name__}"
    GEMMA_ATTENTION_CLASSES[key] = ModifiedAttention
