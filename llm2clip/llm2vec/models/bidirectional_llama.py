...
try:
    from transformers.models.llama.modeling_llama import LLAMA_ATTENTION_CLASSES as HF_LLAMA_ATTENTION_CLASSES
except ImportError:
    HF_LLAMA_ATTENTION_CLASSES = {"eager": LlamaAttention}
    try:
        from transformers.models.llama.modeling_llama import LlamaFlashAttention2
        HF_LLAMA_ATTENTION_CLASSES["flash_attention_2"] = LlamaFlashAttention2
    except ImportError:
        pass
    try:
        from transformers.models.llama.modeling_llama import LlamaSdpaAttention
        HF_LLAMA_ATTENTION_CLASSES["sdpa"] = LlamaSdpaAttention
    except ImportError:
        pass

LLAMA_ATTENTION_CLASSES = {}
for key, cls in HF_LLAMA_ATTENTION_CLASSES.items():
    class ModifiedAttention(cls):
        def __init__(self, *args, **kwargs):
            super().__init__(*args, **kwargs)
            self.is_causal = False
    ModifiedAttention.__name__ = f"Modified{cls.__name__}"
    LLAMA_ATTENTION_CLASSES[key] = ModifiedAttention
