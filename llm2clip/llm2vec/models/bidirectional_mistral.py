...
try:
    from transformers.models.mistral.modeling_mistral import MISTRAL_ATTENTION_CLASSES as HF_MISTRAL_ATTENTION_CLASSES
except ImportError:
    HF_MISTRAL_ATTENTION_CLASSES = {"eager": MistralAttention}
    try:
        from transformers.models.mistral.modeling_mistral import MistralFlashAttention2
        HF_MISTRAL_ATTENTION_CLASSES["flash_attention_2"] = MistralFlashAttention2
    except ImportError:
        pass
    try:
        from transformers.models.mistral.modeling_mistral import MistralSdpaAttention
        HF_MISTRAL_ATTENTION_CLASSES["sdpa"] = MistralSdpaAttention
    except ImportError:
        pass

MISTRAL_ATTENTION_CLASSES = {}
for key, cls in HF_MISTRAL_ATTENTION_CLASSES.items():
    class ModifiedAttention(cls):
        def __init__(self, *args, **kwargs):
            super().__init__(*args, **kwargs)
            self.is_causal = False
    ModifiedAttention.__name__ = f"Modified{cls.__name__}"
    MISTRAL_ATTENTION_CLASSES[key] = ModifiedAttention
