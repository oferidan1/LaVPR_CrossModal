...
try:
    from transformers.models.phi3.modeling_phi3 import PHI3_ATTENTION_CLASSES as HF_PHI3_ATTENTION_CLASSES
except ImportError:
    HF_PHI3_ATTENTION_CLASSES = {"eager": Phi3Attention}
    try:
        from transformers.models.phi3.modeling_phi3 import Phi3FlashAttention2
        HF_PHI3_ATTENTION_CLASSES["flash_attention_2"] = Phi3FlashAttention2
    except ImportError:
        pass
    try:
        from transformers.models.phi3.modeling_phi3 import Phi3SdpaAttention
        HF_PHI3_ATTENTION_CLASSES["sdpa"] = Phi3SdpaAttention
    except ImportError:
        pass

PHI3_ATTENTION_CLASSES = {}
for key, cls in HF_PHI3_ATTENTION_CLASSES.items():
    class ModifiedAttention(cls):
        def __init__(self, *args, **kwargs):
            super().__init__(*args, **kwargs)
            self.is_causal = False
    ModifiedAttention.__name__ = f"Modified{cls.__name__}"
    PHI3_ATTENTION_CLASSES[key] = ModifiedAttention
